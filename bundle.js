...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".bookSummary{\r\n\toverflow: hidden;\r\n\theight: 13em;\r\n\ttext-overflow: ellipsis;\r\n}\r\n.flex-box{display: inline-flex;}\r\n.flex-box img{height: 55em;width: 30%}\r\n.jumbotron{width: 60%;height: 55em;overflow: hidden;text-overflow: ellipsis;}\r\n.btn-danger{margin-left: 80%;}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var NavLink = __webpack_require__(227);
		...
		render: function render() {
			if (this.state.list.length > 0) {
				...
				for (var i = 0; i < listLen; i++) {
					...
					lst.push(React.createElement(
						...
						React.createElement(
							'div',
							{ className: 'col-lg-4 text-center', key: i },
							React.createElement('img', { className: 'img-circle text-center',
				...
				if (this.state.list2.length > 0) {
					...
					for (var j = 0; j < listLen2; j++) {
						...
						lst2.push(React.createElement(
							'div',
							null,
							React.createElement(
								'div',
								{ className: 'col-lg-4 text-center', key: data2[j].id },
								React.createElement('img', { className: 'img-circle text-center', src: data2[j].images.small,
									alt: 'Generic placeholder image', width: '140', height: '140' }),
								React.createElement(
									'h2',
									null,
								...
								React.createElement(
									...
									React.createElement(
										NavLink,
										{ to: detailUrl2, className: 'btn btn-default', role: 'button' },
										'\u67E5\u770B\u8BE6\u7EC6\u4FE1\u606F>>'
									)
								)
							)
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						NavLink,
						{ to: '/list/qc?_k=244436', type: 'button', className: 'btn btn-danger' },
						'\u67E5\u770B\u5217\u8868'
					),
					React.createElement(
						'h1',
					...
					React.createElement(
						NavLink,
						{ to: '/list/kh?_k=g16ese', type: 'button', className: 'btn btn-danger' },
						'\u67E5\u770B\u5217\u8868'
					)
				)
			);
				...
				if (this.state.list.length > 0) {
					...
					for (var i = 0; i < listLen; i++) {
						...
						lst.push(React.createElement(
							...
							React.createElement(
								'div',
								{ className: 'col-lg-4 text-center', key: data[i].id },
								React.createElement('img', { className: 'img-circle text-center',
									src: data[i].images.small,
									alt: 'Generic placeholder image', width: '140', height: '140' }),
								React.createElement(
				...
				if (this.state.list2.length > 0) {
					...
					for (var i = 0; i < listLen2; i++) {
						...
						lst2.push(React.createElement(
							...
							React.createElement(
								'div',
								{ className: 'col-lg-4 text-center', key: data2[i].id },
								React.createElement('img', { className: 'img-circle text-center',
				...
				for (var j = 0; j < bookslen; j++) {
					if (books[j].id == thisbookid) {
						return React.createElement(
							'div',
							{ className: 'flex-box' },
							React.createElement('img', { src: books[j].images.large }),
							React.createElement(
								'div',
								{ className: 'jumbotron disline', keys: books[j].id },
								React.createElement(
									'h1',
									null,
									books[j].title
								...
								React.createElement(
									...
									React.createElement(
										'a',
										{ className: 'btn btn-primary btn-lg', href: books[j].url, role: 'button' },
										'\u9605\u8BFB\u539F\u6587'
									)
								)
							)
				...
				for (var j = 0; j < books2len; j++) {
					if (books2[j].id == thisbookid2) {
						return React.createElement(
							'div',
							{ className: 'flex-box' },
							React.createElement('img', { src: books2[j].images.large }),
							React.createElement(
								'div',
								{ className: 'jumbotron disline', keys: books2[j].id },
								React.createElement(
									'h1',
									null,
									books2[j].title
								...
								React.createElement(
									...
									React.createElement(
										'a',
										{ className: 'btn btn-primary btn-lg', href: books2[j].url, role: 'button' },
										'\u9605\u8BFB\u539F\u6587'
									)
								)
							)
